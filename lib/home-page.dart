                ...
                child: Material(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        child: ClipRRect(
                          child: Image.asset("lib/assets/peru.jpg"),
                        ),
                      ),
                      Container(
                        width: 260.0,
                        ...
                        child: ListTile(
                          title: Text('Peru'),
                          subtitle: Text(
                              'O monumento na plaza de armas, cidade de lima, Peru'),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: ListTile(
                          title: Text('Itália'),
                          subtitle: Text(
                              'Veneza é formada por mais de 100 pequenas ilhas'),
                          trailing: Icon(Icons.favorite_border),
                        ),
                      )
                    ],
                ...
                child: Material(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        child: ClipRRect(
                          child: Image.asset("lib/assets/franca.jpg"),
                        ),
                      ),
                      Container(
                        width: 260.0,
                ...
                child: Material(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        child: ClipRRect(
                          child: Image.asset("lib/assets/catar.jpg"),
                        ),
                      ),
                      Container(
                        width: 260.0,
                        ...
                        child: ListTile(
                          title: Text('Catar'),
                          subtitle: Text(
                              'O Catar é considerado o país mais rico do mundo'),
                          trailing: Icon(Icons.favorite_border),
                        ),
                      )
                    ],
                ...
                child: Material(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        child: ClipRRect(
                          child: Image.asset("lib/assets/china.jpg"),
                        ),
                      ),
                      Container(
                        width: 260.0,
                        ...
                        child: ListTile(
                          title: Text('China'),
                          subtitle: Text(
                              'A Grande Muralha: uma das 7 maravilhas do mundo'),
                          trailing: Icon(Icons.favorite_border),
                        ),
                      )
                    ],
                ...
                child: Material(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        child: ClipRRect(
                          child: Image.asset("lib/assets/novay.jpg"),
                        ),
                      ),
                      Container(
                        width: 260.0,
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                              'Visitar a Estátua da Liberdade é a mais procurada.'),
                          trailing: Icon(Icons.favorite_border),
                        ),
                      )
                    ],
                ...
                child: Material(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        child: ClipRRect(
                          child: Image.asset("lib/assets/canada.jpg"),
                        ),
                      ),
                      Container(
                        width: 260.0,
                        ...
                        child: ListTile(
                          title: Text('Canada'),
                          subtitle: Text(
                              'Toronto tem em média 301 dias de sol mensurável.'),
                          trailing: Icon(Icons.favorite_border),
                        ),
                      )
                    ],
